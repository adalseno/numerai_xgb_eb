...
print('Reading bestplus training data')
...
# select feature set
features = feature_metadata["feature_sets"]["bestplus"]
...
validation_data["prediction"].to_csv(f"validation_predictions_{current_round}_32.csv")
